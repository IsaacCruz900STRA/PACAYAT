// src/pages/secretaria/Avisos.jsx — CRUD completo con COLABORADORES y documentos adjuntos
...
export default function SecretariaAvisos() {
  ...
  const handleEliminar = async (id) => {
    ...
    try { await deleteAviso(id); showToast('Aviso eliminado', 'info'); cargar(); }
        ...
        <form onSubmit={handleGuardar}>
          <div style={{ display: 'grid', gap: '1rem' }}>
            <div>
              ...
              <select value={form.tipo} onChange={e => setForm(p => ({ ...p, tipo: e.target.value }))} style={{ ...inputS, appearance: 'none' }}>
